...
import { Card, Heading, Link, Box, Button } from "theme-ui";
...
const GitHubCommit: React.FC<{ children?: string }> = ({ children }) =>
    children?.match(/[0-9a-f]{40}/) ? (
        <Link href={`https://github.com/chmllr/liquity-fe/commit/${children}`}>
            {children.substr(0, 7)}
        </Link>
    ) : (
        <>unknown</>
...
export const ImtblControls: React.FC<any> = ({ variant = "info" }) => {
    const {
        liquity: {
    ...
    return (
        <Card {...{ variant }}>
            ...
            <Box sx={{ fontSize: 0 }}>
                <input
                    type="checkbox"
                    defaultChecked={feature["trove"]}
                    onChange={() => toggleFeature("trove")}
                />
                Trove &nbsp;
                <input
                    type="checkbox"
                    defaultChecked={feature["sp"]}
                    onChange={() => toggleFeature("sp")}
                />
                Stability Pool &nbsp;
                <input
                    type="checkbox"
                    defaultChecked={feature["staking"]}
            ...
            <Box sx={{ mt: 3, opacity: 0.66 }}>
                ...
                <Box sx={{ fontSize: 0 }}>
                    Updates & contact:{" "}
                    <Link href="https://taggr.link/#/journal/imtbl">imtbl@TAGGR</Link>
                </Box>
            </Box>
            <br />
            <Box>
                <Link href="https://internetcomputer.org">
                    ...
                    >
                        ...
                        <path
                            ...
                            fill="url(#paint2_linear_1731_62)"
                        />
                        <path
